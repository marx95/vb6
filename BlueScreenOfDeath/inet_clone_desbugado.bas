...
Public Function ProgressBar(sFiles As String, lDone As Long)
    ...
    Update.pbDownload.Value = (lDone / Tamanho) * 100

    On Error Resume Next
    Update.lbDownload.Caption = CorrigePeso(lDone) & " / " & CorrigePeso(Tamanho)
End Function
